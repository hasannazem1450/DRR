...
namespace DRR.Application.MessageCodes.IdentityPersianErrorsHandler
{
    public class PersianIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError DuplicateUserName(string userName)
            => new IdentityError()
            {
                ...
                Description = $"نام کاربری {userName} قبلا توسط شخص دیگری انتخاب شده است@The {userName} UserName is already taken by another person"
            };
